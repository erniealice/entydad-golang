...
import (
	...
	useraction "github.com/erniealice/entydad-golang/views/user/action"
	userdashboard "github.com/erniealice/entydad-golang/views/user/dashboard"
	userdetail "github.com/erniealice/entydad-golang/views/user/detail"
...
// Module holds all constructed user views.
type Module struct {
	routes        entydad.UserRoutes
	Dashboard     view.View
	List          view.View
