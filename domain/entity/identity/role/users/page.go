...
func userColumns(l role.UserLabels) []types.TableColumn {
...
func buildTableRows(users []UserByRole, roleID string, l role.UserLabels, sl entydad.SharedLabels, routes role.Routes) []types.TableRow {
	rows := []types.TableRow{}
