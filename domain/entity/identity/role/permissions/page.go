...
func permissionColumns(l role.PermissionLabels) []types.TableColumn {
...
func buildTableRows(role *rolepb.Role, l role.PermissionLabels, sl entydad.SharedLabels, routes role.Routes) []types.TableRow {
	rows := []types.TableRow{}
