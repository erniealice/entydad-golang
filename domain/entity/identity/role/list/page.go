...
func roleColumns(l role.Labels) []types.TableColumn {
...
func buildBulkActions(l role.Labels, sl entydad.SharedLabels, common pyeza.CommonLabels, routes role.Routes, perms *types.UserPermissions) []types.BulkAction {
