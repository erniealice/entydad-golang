...
func userColumns(l user.Labels) []types.TableColumn {
...
func statusTitle(l user.Labels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l user.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l user.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l user.Labels, status string) string {
	switch status {
	case "active":
...
func buildBulkActions(l user.Labels, sl entydad.SharedLabels, common pyeza.CommonLabels, status string, routes user.Routes, perms *types.UserPermissions) []types.BulkAction {
