...
func permissionColumns(l permission.Labels) []types.TableColumn {
...
func statusTitle(l permission.Labels, status string) string {
	switch status {
	case "active":
...
func statusSubtitle(l permission.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyTitle(l permission.Labels, status string) string {
	switch status {
	case "active":
...
func statusEmptyMessage(l permission.Labels, status string) string {
	switch status {
	case "active":
...
func buildBulkActions(l permission.Labels, sl entydad.SharedLabels, common pyeza.CommonLabels, status string, routes permission.Routes, perms *types.UserPermissions) []types.BulkAction {
