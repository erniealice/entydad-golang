...
import (
	...
	locationareapkg "github.com/erniealice/entydad-golang/domain/entity/location/location_area"
	...
	locationdetail "github.com/erniealice/entydad-golang/domain/entity/location/location/detail"
	locationlist "github.com/erniealice/entydad-golang/domain/entity/location/location/list"
...
// LocationModuleDeps holds all dependencies for the location module.
type LocationModuleDeps struct {
	Routes               locationpkg.Routes
	CommonLabels         pyeza.CommonLabels
	SharedLabels         entydad.SharedLabels
	Labels               locationpkg.Labels
	...
	LocationAreaRoutes locationareapkg.Routes
...
// LocationModule holds all constructed location views.
...
func NewLocationModule(deps *LocationModuleDeps) *LocationModule {
...
func (m *LocationModule) RegisterRoutes(r view.RouteRegistrar) {
