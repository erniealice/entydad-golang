...
func buildTableRows(categories []*categorypb.Category, supplierCounts map[string]int, routes entitysuppliertag.Routes, inUseIDs map[string]bool, l entitysuppliertag.Labels, sl entydad.SharedLabels) []types.TableRow {
	rows := []types.TableRow{}
...
func buildBulkActions(l entitysuppliertag.Labels, sl entydad.SharedLabels, cl pyeza.CommonLabels, routes entitysuppliertag.Routes) []types.BulkAction {
