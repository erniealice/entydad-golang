...
import (
	...
	suppliertag "github.com/erniealice/entydad-golang/domain/entity/party/supplier/tag"
	suppliertagaction "github.com/erniealice/entydad-golang/domain/entity/party/supplier/tag/action"
...
// SupplierTagModuleDeps holds all dependencies for the supplier tag module.
type SupplierTagModuleDeps struct {
	Routes                  entitysuppliertag.Routes
	Labels                  entitysuppliertag.Labels
...
// SupplierTagModule holds all constructed supplier tag views.
type SupplierTagModule struct {
	routes        entitysuppliertag.Routes
	List          view.View
	Table         view.View
	Add           view.View
...
func NewSupplierTagModule(deps *SupplierTagModuleDeps) *SupplierTagModule {
...
func (m *SupplierTagModule) RegisterRoutes(r view.RouteRegistrar) {
