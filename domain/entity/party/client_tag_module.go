...
import (
	...
	clienttag "github.com/erniealice/entydad-golang/domain/entity/party/client/tag"
	clienttagaction "github.com/erniealice/entydad-golang/domain/entity/party/client/tag/action"
	entityclienttag "github.com/erniealice/entydad-golang/domain/entity/party/client_tag"
	categorypb "github.com/erniealice/esqyma/pkg/schema/v1/domain/common"
	clientcategorypb "github.com/erniealice/esqyma/pkg/schema/v1/domain/entity/client_category"
)

// ClientTagModuleDeps holds all dependencies for the client tag module.
type ClientTagModuleDeps struct {
	Routes                  entityclienttag.Routes
	Labels                  entityclienttag.Labels
...
// ClientTagModule holds all constructed client tag views.
type ClientTagModule struct {
	routes        entityclienttag.Routes
	List          view.View
	Table         view.View
	Add           view.View
...
func NewClientTagModule(deps *ClientTagModuleDeps) *ClientTagModule {
...
func (m *ClientTagModule) RegisterRoutes(r view.RouteRegistrar) {
