...
func NewView(deps *Deps) view.View {
	return view.ViewFunc(func(ctx context.Context, viewCtx *view.ViewContext) view.ViewResult {
		...
		columns := []types.TableColumn{
			...
			{Key: "customers", Label: l.Columns.Customers, NoSort: true, WidthClass: "col-2xl"},
...
func buildTableRows(categories []*categorypb.Category, customerCounts map[string]int, routes entityclienttag.Routes, inUseIDs map[string]bool, l entityclienttag.Labels, sl entydad.SharedLabels) []types.TableRow {
	rows := []types.TableRow{}
...
func buildBulkActions(l entityclienttag.Labels, sl entydad.SharedLabels, cl pyeza.CommonLabels, routes entityclienttag.Routes) []types.BulkAction {
